class GlobalLink < ActiveRecord::Base
  ...
  belongs_to :global_node_to, :class_name => "GlobalNode", :foreign_key=>'global_node_to_id'
  belongs_to :global_node_from, :class_name => "GlobalNode", :foreign_key=>'global_node_from_id'
  belongs_to :node_to, :class_name => "Node", :foreign_key=>'node_to_id'
  belongs_to :node_from, :class_name => "Node", :foreign_key=>'node_from_id'
