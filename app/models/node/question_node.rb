class Node::QuestionNode < Node
  ...
  has_many :negative_link_froms, :foreign_key => "node_to_id", :class_name => "Link::QuestionLink::NegativeQuestionLink", :conditions => {:active => true}
  has_many :negative_link_tos, :foreign_key => "node_from_id", :class_name => "Link::QuestionLink::NegativeQuestionLink", :conditions => {:active => true}
